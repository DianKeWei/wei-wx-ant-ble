...
__DEFINE__(1719298542458, function(require, module, exports) {
...
if (!exports.__esModule) Object.defineProperty(exports, "__esModule", { value: true });Object.defineProperty(exports, 'Version', { enumerable: true, configurable: true, get: function() { return Version; } });Object.defineProperty(exports, 'BTManager', { enumerable: true, configurable: true, get: function() { return BTManager; } });Object.defineProperty(exports, 'ConnectStatus', { enumerable: true, configurable: true, get: function() { return ConnectStatus; } });Object.defineProperty(exports, 'SuccessCallbackEvent', { enumerable: true, configurable: true, get: function() { return SuccessCallbackEvent; } });Object.defineProperty(exports, 'ErrorCallbackEvent', { enumerable: true, configurable: true, get: function() { return ErrorCallbackEvent; } });Object.defineProperty(exports, 'SuccessApiThen', { enumerable: true, configurable: true, get: function() { return SuccessApiThen; } });Object.defineProperty(exports, 'ErrorApiCatch', { enumerable: true, configurable: true, get: function() { return ErrorApiCatch; } });
...
}, function(modId) {var map = {"./src/btmanager.js":1719298542459,"./src/enum.js":1719298542461}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1719298542459, function(require, module, exports) {
...
if (!exports.__esModule) Object.defineProperty(exports, "__esModule", { value: true });class BTManager {
  ...
  connect(device , timeout) {
    ...
    return this._bt.connect(device, timeout);
  }
...
};exports.BTManager = BTManager
}, function(modId) { var map = {"./extends.js":1719298542460,"./enum.js":1719298542461,"./bluetooth.js":1719298542462}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1719298542460, function(require, module, exports) {


if (!exports.__esModule) Object.defineProperty(exports, "__esModule", { value: true });function Log() {
...
__DEFINE__(1719298542461, function(require, module, exports) {
...
__DEFINE__(1719298542462, function(require, module, exports) {
...
if (!exports.__esModule) Object.defineProperty(exports, "__esModule", { value: true });class Bluetooth {
  ...
  openAndListenBluetoothAdapter() {
    ...
    if (!this.isInitializedAdapter) {
      // 监听蓝牙适配器状态
      _.on('offBluetoothAdapterStateChange', '', res=>{});
  ...
  scanDevice(options) {
    ...
    return this.openAndListenBluetoothAdapter()
      .then(__ => {
        ...
        // 取消设备监听，仅支付宝小程序有效
        _.on('offBluetoothDeviceFound', '', res=>{});
        // 监听扫描到外设
        _.on('onBluetoothDeviceFound','', res => {
          ...
          for (let device of devices) {
            ...
            // 匹配名称，过滤设备
            let name = device.localName || device.deviceName;
            device.name = name;
   ...
   */
    ...
    return this.openAndListenBluetoothAdapter()
      .then(__ => {
        ...
        _.on('offBLEConnectionStateChange', '', res=>{});
        // 蓝牙连接状态监听
  ...
  registerDidUpdateValueForCharacteristic(cb) {
    ...
    _.on('offBLECharacteristicValueChange', '', res => {});
...
}, function(modId) { var map = {"./enum.js":1719298542461,"./tools.js":1719298542463}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1719298542463, function(require, module, exports) {
...
}, function(modId) { var map = {"./promisify.js":1719298542464}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1719298542464, function(require, module, exports) {
 ...
 * 获取小程序平台 wx||ant
 */
if (!exports.__esModule) Object.defineProperty(exports, "__esModule", { value: true });function getAppPlatform() {
  return mini;
 ...
 *  @return Promise对象
 */
if (!exports.__esModule) Object.defineProperty(exports, "__esModule", { value: true });function api(fn1, fn2, options) {
 ...
 *  @param {function} cb 回调函数
 */
if (!exports.__esModule) Object.defineProperty(exports, "__esModule", { value: true });function on(fn1, fn2, cb) {
  let func = ii[fn1] || ii[fn2];
  if (func) {
    if (mini === 'wx') {
      func(cb);
...
}, function(modId) { var map = {"./enum.js":1719298542461}; return __REQUIRE__(map[modId], modId); })
return __REQUIRE__(1719298542458);
})()
